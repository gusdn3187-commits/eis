...
var SEED = {
 ...
 ASM:[["수익성", "매출총이익률", "%", 26.6, 27.2, "물가상승률 1.9%, 환율 연평균 1,400원/달러"], ["수익성", "SW제품(BK제외)", "%", 2.6, 3.4, "제조단가 5,164→5,220천원/톤"], ["수익성", "창원SW", "%", -5.2, -3.0, "생산량 180톤/월, 수율 85.0→86.0%"], ["수익성", "제천SW", "%", 6.5, 7.2, "생산량 380톤/월, 수율 85.0→86.0%"], ["수익성", "OEM SW", "%", 44.3, 44.8, "환율 1,380원/달러, 해상·육상운임 동결"], ["수익성", "SW상품", "%", 26.8, 27.0, "매입단가 인상분 일부 반영"], ["수익성", "수전", "%", 19.6, 20.4, "인고트단가 11,500원/kg, 안산 수전바디 외주화 연간 반영"], ["수익성", "비데", "%", 30.7, 31.2, "원재료비·외주가공비 안정"], ["수익성", "타일·본드", "%", 16.4, 16.8, "타일 매입환율 1,380원/달러"], ["수익성", "BK", "%", 34.6, 35.0, "품목군별 평균원가율 기준"], ["수익성", "케어", "%", 22.7, 23.2, "렌탈 15.4%, 멤버십 23.1% 기준"], ["거시", "환율(연평균)", "원", 1400, 1380, "원/달러"], ["거시", "물가상승률", "%", 1.9, 1.9, ""], ["거시", "호봉 승급", "%", 1.5, 1.5, ""], ["거시", "임금인상률", "%", 0.0, 3.2, "2026년 동결 → 2027년 정상화"], ["판관비", "경비", "백만원", 25416, 25798, "마케팅 예산 1,510백, 지급수수료 600백 포함"], ["인건비", "인건비 계", "백만원", 43878, 45154, ""], ["인건비", "제조원가", "백만원", 25317, 25999, "승급 1.5%"], ["인건비", "판관비", "백만원", 18561, 19155, "승급 1.5%, 인원충원 6명"], ["금융", "금융비용", "백만원", 2039, 2039, ""], ["금융", "차입금(연평균)", "백만원", 69900, 69900, "신규 차입 없음"], ["금융", "금융비용/차입금", "%", 2.9, 2.9, ""], ["지분법", "지분법손익", "백만원", 577, 577, "이익 586 / 손실 9"], ["투자", "시설투자", "백만원", 3087, 1465, "2026년 대규모 투자 종료"], ["투자", "감가상각비", "백만원", 2896, 2750, "제조 1,761 / 판관 1,136"]],
